...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x08  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
	  ...
	  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)1  } }, /* 3 Cluster: Keep-Alive, Attribute: Keep-Alive Base, Side: server*/ \
	  { 0x0001, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)60  } }, /* 4 Cluster: Keep-Alive, Attribute: Keep-Alive Jitter, Side: server*/ \
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x0001  } }, /* 5 Cluster: Keep-Alive, Attribute: cluster revision, Side: server*/ \
	  { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT| ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x0000  } }, /* 6 Cluster: Key Establishment, Attribute: key establishment suite (client), Side: client*/ \
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT| ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)2  } }, /* 7 Cluster: Key Establishment, Attribute: cluster revision, Side: client*/ \
	  { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x0000  } }, /* 8 Cluster: Key Establishment, Attribute: key establishment suite (server), Side: server*/ \
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)2  } } /* 9 Cluster: Key Establishment, Attribute: cluster revision, Side: server*/ \
	}
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0025, (EmberAfAttributeMetadata*)&(generatedAttributes[3]), 3, 5, CLUSTER_MASK_SERVER, NULL }, /* 1, Endpoint Id: 1, Cluster: Keep-Alive, Side: server*/ \
  { 0x0800, (EmberAfAttributeMetadata*)&(generatedAttributes[6]), 2, 4, CLUSTER_MASK_CLIENT, NULL }, /* 2, Endpoint Id: 1, Cluster: Key Establishment, Side: client*/ \
  { 0x0800, (EmberAfAttributeMetadata*)&(generatedAttributes[8]), 2, 4, CLUSTER_MASK_SERVER, NULL } /* 3, Endpoint Id: 1, Cluster: Key Establishment, Side: server*/ \
}

#define GENERATED_ENDPOINT_TYPE_COUNT (1)
// This is an array of EmberAfEndpointType structures.
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 4, 17 }, \
}
